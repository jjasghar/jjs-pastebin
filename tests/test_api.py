...
class TestAPIAuth:
    ...
    def test_api_requires_auth(self, client, api_headers):
        ...
        response = client.post('/api/pastes', 
                             headers=api_headers,
...
class TestAPIPastes:
    ...
    def test_get_all_pastes(self, client, test_paste, api_headers):
        ...
        expected_fields = ['id', 'title', 'language', 'is_public', 'author', 'created_at', 'views']
    ...
    def test_get_paste_by_id(self, client, test_paste, api_headers):
        ...
        response = client.get(f'/api/pastes/{test_paste.unique_id}', headers=api_headers)
    ...
    def test_get_private_paste_unauthorized(self, client, private_paste, api_headers):
        ...
        response = client.get(f'/api/pastes/{private_paste.unique_id}', headers=api_headers)
        
        assert response.status_code == 404  # Private pastes return 404 to non-owners
    
    def test_get_private_paste_authorized(self, client, test_user, private_paste, api_headers):
    ...
    def test_update_paste(self, client, test_user, test_paste, api_headers):
        ...
        response = client.put(f'/api/pastes/{test_paste.unique_id}',
                            headers=headers,
    ...
    def test_delete_paste_unauthorized(self, client, test_paste, api_headers):
        ...
        response = client.delete(f'/api/pastes/{test_paste.unique_id}', headers=api_headers)
...
class TestAPIUsers:
    ...
    def test_get_user_pastes(self, client, test_user, test_paste, api_headers):
        ...
        response = client.get(f'/api/users/{test_user.username}/pastes', headers=api_headers)
