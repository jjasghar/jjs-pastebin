...
class TestPasteRoutes:
    ...
    def test_view_private_paste_unauthorized(self, client, private_paste):
        ...
        assert response.status_code == 404  # Private pastes should return 404 to unauthorized users
    
    def test_view_private_paste_authorized(self, client, auth, test_user, private_paste):
    ...
    def test_edit_paste_post(self, client, auth, test_user, test_paste, app):
        ...
        response = client.post(f'/paste/{test_paste.unique_id}/edit', data={
            'title': 'Updated Title',
...
class TestUserRoutes:
    ...
    def test_user_profile(self, client, test_user, test_paste):
        ...
        assert b'Profile' in response.data or test_user.username.encode() in response.data
