...
def upload_test():
    ...
    print("Then test install: pip install --index-url https://test.pypi.org/simple/ jj-pastebin-cli")
...
def main():
    ...
    required_files = ['setup-cli.py', 'CLI-README.md', 'pyproject.toml', 'cli/jj.py']
    ...
    print("2. Test install: pip install --index-url https://test.pypi.org/simple/ jj-pastebin-cli")
